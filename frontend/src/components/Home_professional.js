...
//                 this.showRequestModal = true; // Changed variable name
//             } catch (error) {
...
//             try {
//                 await axios.post(`http://localhost:5000/service_request_action/${id}/accept`, {}, {
//                     headers: {
//                         Authorization: `Bearer ${this.$store.getters.authToken}`
//                     }
//                 });
    ...
    methods: {
        ...
        async viewRequest(id) {
            try {
                ...
                const allRequests = [
                ...response.data.accepted_requests,
                ...response.data.completed_requests,
                ...response.data.pending_requests
                ];
                
                // Find the request with the matching id
                this.selectedRequest = allRequests.find(req => req.id === id);
