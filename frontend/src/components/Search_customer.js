...
//             }
//         },
//         async StartbookService(professional) {
//             this.isBooking = true;
//             this.selectedProfessional = professional;
//         },
//         async bookService(professional,service_id) {
//             try {
//                 const token = this.$store.getters.authToken;
//                 if (!token) {
//                     console.error("Auth token missing!");
//                     return;
//                 }
//                 console.log("book prof",professional);
//                 console.log("book service",service_id);


//                 const response = await axios.post(
//                     `http://localhost:5000/book_service/${this.userId}/${professional.professional?.service_id}`, 
//                     { professional_id: professional.id, service_id: professional.professional?.service_id },
//                     { headers: { Authorization: `Bearer ${token}` } }
//                 );
...
//                     <td>
//                         <button class="btn btn-success" @click="bookService(professional.professional.id,professional.professional.service_id)">Book</button>
//                     </td>
//                 </tr>
//             </tbody>
//         </table>
